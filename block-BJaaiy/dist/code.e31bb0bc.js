...
console.log(chunked);
var compact = lodash.compact([0, 1, false, 2, "", 3]);
console.log(compact); // Moment
...
var dateA = moment("11-11-2014", "DD-MM-YYYY");
var dateB = moment("11-09-2015", "DD-MM-YYYY");
console.log(dateA.from(dateB));
var dateD = moment("2014-11-11");
